...
double latitude;//現在緯度
double* lat_Ptr=&latitude;//現在緯度のポインタ
double longitude;//現在経度
double* lon_Ptr=&longitude;//現在緯度のポインタ
double latitude_goal;//目標緯度(単体)
double* latGoal_Ptr=&latitude_goal;//現在緯度のポインタ
double longitude_goal;//目標経度（単体）
double* lonGoal_Ptr=&longitude_goal;//現在経度のポインタ
