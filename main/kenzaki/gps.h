...
#define DEV_NAME    "/dev/ttyUSB2"        // デバイスファイル名　ここは環境に合わせて変える必要がある
...
//	  printf("\n");
	...
	if(buffer[kouho+6]==0x40 && buffer[INS+7+38]==0x04 ){ 
		...
		*dummykeido++;
			...
			sprintf(ido,"/home/itolab/work/toma/test/gps/latitude_goal.txt");
			char dido[255];
			ofstream GPSido(ido);
			...
			sprintf(keido,"/home/itolab/work/toma/test/gps/longitude_goal.txt");
			char dkeido[255];
